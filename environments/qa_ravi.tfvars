# =============================================================================
# qa ENVIRONMENT — (account: <YOUR_QA_ACCOUNT_ID>, region: ap-south-1)
# Upload to S3 then delete local copy:
#   aws s3 cp environments/qa.tfvars s3://aurora-snap-mgmt-tfstate-<YOUR_QA_ACCOUNT_ID>/config/qa.tfvars
# Run:
